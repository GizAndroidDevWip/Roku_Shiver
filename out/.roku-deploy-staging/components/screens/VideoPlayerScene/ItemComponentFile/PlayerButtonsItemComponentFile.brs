...
sub updateContent()
    ...
    if m.top.itemContent.id = "play_next"
        m.icon.uri = "pkg:/images/play_next.png"
        itemVisibility(false)

    else if m.top.itemContent.id = "Play_previous"
        m.icon.uri = "pkg:/images/icons/play_previous.png"
        itemVisibility(false)

    else if m.top.itemContent.id = "Language"
        m.icon.uri = "pkg:/images/icons/global_mini.png"
        itemVisibility(false)

    else if m.top.itemContent.id = "START_OVER"
        m.icon.uri = "pkg:/images/icons/startOver.png"
        itemVisibility(false)

    else if m.top.itemContent.id = "MultiResolution"
        m.icon.uri = "pkg:/images/icons/hd_lite.png"
        itemVisibility(false)

    else if m.top.itemContent.id = "Comments"
        m.icon.uri = "pkg:/images/icons/comment.png"
        itemVisibility(false)

    else if m.top.itemContent.id = "Speed"
        m.icon.uri = "pkg:/images/icons/clock.png"
        itemVisibility(false)

    else if m.top.itemContent.id = "go_ads_free"
        m.icon.uri = "pkg:/images/icons/ad_free.png"
        itemVisibility(false)
    ...
    if m.top.itemContent.watched_duration <> invalid then
        m.watchProgressLine.width = (m.top.itemContent.watched_duration / 100.0) * m.watchProgressContainer.width
    else
...
sub updateLayout()
    ...
    m.iconLabel.width = m.top.width + 20
