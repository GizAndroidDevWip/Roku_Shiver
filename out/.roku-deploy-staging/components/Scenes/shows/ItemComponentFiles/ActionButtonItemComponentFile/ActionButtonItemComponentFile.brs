...
sub updateContent()
    ...
    if content.title <> invalid
        ...
        if m.top.focusPercent <> invalid and m.top.focusPercent > 0.5
            m.label.color = getOppositeColorOfInput("#000000")
        else
            m.label.color = getOppositeColorOfInput("#FFFFFF")
        end if
    end if
    ...
    if content.isHighlighted <> invalid and content.ishighlighted = true
        ...
        if m.top.itemHasFocus <> invalid and m.top.itemHasFocus = true
            m.icon.blendColor = getOppositeColorOfInput("#000000")
        else
            m.icon.blendColor = getOppositeColorOfInput("#FFFFFF")
        end if
    end if
...
'         m.bg.blendColor = getOppositeColorOfInput("#FFFFFF")
'         m.label.color = getOppositeColorOfInput("#000000")
'         ' m.buttonLeftIcon.blendColor = getOppositeColorOfInput("#000000")
'     else
'         m.bg.blendColor = "#3A3A5A"
'         m.label.color = getOppositeColorOfInput("#FFFFFF")
'         ' m.buttonLeftIcon.blendColor = getOppositeColorOfInput("#FFFFFF")
'     end if
' end sub
...
sub updateLayout()
    ...
    newWidth =  50
    m.iconLabel.width = m.top.width + newWidth
    m.iconLabel.translation = [0 - (newWidth/2), 75]
