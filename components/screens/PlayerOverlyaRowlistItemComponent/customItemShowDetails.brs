sub Init()
    ?"PlayerOverlyaRowlistItemComponent init called"
    ...
    m.name_label.color = "#FFFFFF"
    m.sub_label.color = "#FFFFFF"
    m.descriptionBanner.color = "#FFFFFF"
end sub
...
sub itemContentChanged()
    ...
    ' ? "PlayerOverlyaRowlistItemComponent itemContent data printed"
    ' ? m.top.itemContent
    ...
    if m.top.itemContent.DoesExist("itemType")
        if m.top.itemContent.itemType = "videos"
            m.Progressbar.visible = true
            if m.top.itemContent.DoesExist("watched_percentage")
                ? "Title printed : " + m.top.itemContent.title
