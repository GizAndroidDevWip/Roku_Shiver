sub ShowShowPageForLiveEventScreenStackLogicScreen(focusedContent)
    m.ShowPageForLiveEvent = CreateObject("roSGNode", "ShowPageForLiveEvent")
    m.ShowPageForLiveEvent.observeField("gotoLandingScene","onGoToLandingScene")
    m.ShowPageForLiveEvent.ObserveField("goToPaymentDescriptionScreen","onGoToPaymentDescriptionScree2")
    m.ShowPageForLiveEvent.ObserveField("goToPaymentDescriptionScreenForEvent","onGoToPaymentDescriptionScreenforEvent")
    m.ShowPageForLiveEvent.ObserveField("rowItemSelected","onGoToShowScrnFrmShwDtlScrnWhenClckingUMayAlsoLikeVideo")

    ?"ShowShowPageForLiveEventScreenStackLogicScreen called"
    m.ShowPageForLiveEvent.itemType = focusedContent.itemType
    m.ShowPageForLiveEvent.upcomingEventId = focusedContent.upcomingEventId
    ShowScreen(m.ShowPageForLiveEvent)
end sub
